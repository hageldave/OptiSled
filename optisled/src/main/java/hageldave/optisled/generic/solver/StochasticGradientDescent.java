 ...
 * When the random number changes the gradient, that was passed to 
 * {@link #arg_min(ScalarFN, VectorFN, Object)}, needs to change behavior to only be non-zero on a subset of
 * its dimensions (based on the random number).
 * <p>
